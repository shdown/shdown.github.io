...
2018 $\cdot$ Software architect (private start-up company) $\cdot$ Implemented infrastructure, bots and various utilites for analysis of order flow and algorithmic trading on a number of cryptoexchanges (Python, MySQL, Redis);
...
have developed a fast log analyzer (C++).
...
\begin{tabular}{ l l }
    2015 & \href{https://github.com/shdown/old-stuff/tree/master/gt}{\textbf{gt}}, a client and library for Google Translate (defunct) \\
