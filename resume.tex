...
developed a web interface for accounting and monitoring the status of trading bots in the real time (Python, Flask, JavaScript);
have developed a log analyzer (C++).
