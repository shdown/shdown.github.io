...
\begin{tabularx}{\textwidth}{ l X }
    ...
    2016---present & \uwave{\href{https://github.com/shdown/luastatus}{\textbf{luastatus}}, a universal status bar content generator}
    \newline
    ...
    2020 & \uwave{\href{https://github.com/shdown/libdeci}{\textbf{libdeci}}, an arbitrary-precision decimal arithmetic library for C}
    \newline
    ...
    2020---present & \uwave{\href{https://github.com/shdown/calx}{\textbf{calx}}, a bc-like programming language}
    \newline
    ...
    2020 & \uwave{\href{https://github.com/shdown/decimal-multiplication-paper}{\textbf{``Speeding up decimal multiplication''}}, a research project} (\href{https://arxiv.org/abs/2011.11524}{\textbf{ArXiv.org URL}}).
    \newline
    ...
    2022 & \uwave{\href{https://github.com/shdown/fiwia}{\textbf{FiWiA}}, a generator of x86-64 machine code for fixed-width multi-word arithmetics}
    \newline
    ...
    2022 & \uwave{\href{https://github.com/shdown/sloppy-json}{\textbf{sloppy-json}}, span-oriented C JSON parser with an external preprocessor to sweeten the process of parsing}
    \newline
...
\begin{tabularx}{\textwidth}{ l X }
    ...
    2025 & \uwave{\href{https://github.com/shdown/glass-paper}{\textbf{``glass: ordered set data structure for client-side order books''}}, a paper}
    \newline
    ...
    2025---present & \uwave{\href{https://github.com/shdown/jjhash}{\textbf{jjhash}}, a simple string hash function that has better speed and statistical qualities than FNV-2}
    \newline
